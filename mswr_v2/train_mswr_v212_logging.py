...
def parse_arguments():
    ...
    parser.add_argument("--spectral_ffn", action='store_true', default=False,
                       help="Add a zero-init-gated GDFN spectral feed-forward residual to each block "
                            "(the MSAB FFN the spectral branch lacks); checkpoint-safe, identity at init. "
